...
class TeacherControllerTest {
    ...
    void getAllTeachers() throws Exception{
        ...
        when(teacherService.findAllByOrderByUser()).thenReturn(List.of(t1, t2));
    ...
    void getTeacherBySubjectName() throws Exception{
        ...
        when(teacherService.findBySubjectName("Maths")).thenReturn(t1);

        MvcResult mvcResult = mvc.perform(MockMvcRequestBuilders
                        .get("/teachers/getBySubjectName/Maths"))
                .andDo(print())
                .andExpect(status().isOk())
                .andReturn();
