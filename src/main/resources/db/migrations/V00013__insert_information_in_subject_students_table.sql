insert into subject_Students(student_id, subject_id) values (1, 1);
insert into subject_Students(student_id, subject_id) values (1, 2);
insert into subject_Students(student_id, subject_id) values (2, 1);
